...
async function main() {
  ...
  const myKeypair = loadWalletKey(
    "mrtPKucT9RNEJ2K3k5fDmjBC1kDdNYQdwdnZ9BhJHYW.json"
  );
  console.log(myKeypair.publicKey.toBase58());
  const mint = new web3.PublicKey(
    "thea4NWzuZWEVdvb6c5EML69hVtdTC3pAYqSxvbVfDD"
  );
  ...
  const dataV2 = {
    name: "Murat Artan",
    symbol: "$8290",
    uri: "https://gateway.pinata.cloud/ipfs/Qmeiqz5e6wAHeoU6eLvEbXMicBAcyPm9gmKE2hVyCukhBD",
    // we don't need that
